...
class UsersService {
    ...
    async getProfile(userId) {
        ...
        if (user.dataValues && 'ai_api_key' in user.dataValues) {
            user.dataValues.has_ai_api_key = !!user.dataValues.ai_api_key;
            delete user.dataValues.ai_api_key;
        } else {
            user.has_ai_api_key = !!user.ai_api_key;
            delete user.ai_api_key;
        }
