...
|---|---|---|---|---|
| `28-inbox-chip-color-and-hint.md` | Chip de tag da inbox em cor única neutra + hint `+Projeto` traduzido | Trivial | fraco (haiku) | - |
| `29-sidebar-people-add-button.md` | Botão `+` em PESSOAS na sidebar reusando `PersonModal` | Baixo | fraco (haiku) | - |
